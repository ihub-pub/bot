import {getConfig} from 'release-drafter-github-app/lib/config.js'
import {isTriggerableReference} from 'release-drafter-github-app/lib/triggerable-reference.js'
import {
    findReleases,
    generateReleaseInfo,
    createRelease,
    updateRelease,
} from 'release-drafter-github-app/lib/releases.js'
import {findCommitsWithAssociatedPullRequests} from 'release-drafter-github-app/lib/commits.js'
import {sortPullRequests} from 'release-drafter-github-app/lib/sort-pull-requests.js'
import {log} from 'release-drafter-github-app/lib/log.js'
import * as core from '@actions/core'
import {runnerIsActions} from 'release-drafter-github-app/lib/utils.js'
import ignore from 'ignore'

export function releaseDrafter(app, {getRouter}) {
    ...
    let configUpdate = async (context) => {
