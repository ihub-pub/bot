...
const {isTriggerableReference} = require('release-drafter-github-app/lib/triggerable-reference')
const {
    findReleases,
    generateReleaseInfo,
    createRelease,
    updateRelease,
} = require('release-drafter-github-app/lib/releases')
...
module.exports.releaseDrafter = (app, {getRouter}) => {
